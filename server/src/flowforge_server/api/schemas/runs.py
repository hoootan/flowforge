...
class StepResponse(BaseModel):
    ...
    tool_input: Any | None = Field(None, description="Tool input arguments")
    tool_output: Any | None = Field(None, description="Tool output result")
    agent_state: Any | None = Field(None, description="Agent state snapshot")
...
class RunResponse(BaseModel):
    ...
    attempt: int = Field(..., description="Current attempt number")
    max_attempts: int = Field(..., description="Maximum attempts")
    output: Any | None = Field(None, description="Function output")
    error: Any | None = Field(None, description="Error details")
