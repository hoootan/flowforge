"""Add deleted_at column to tools for soft-delete support."""

from sqlalchemy import text

MIGRATION_ID = "add_tool_soft_delete"
MIGRATION_DATE = "2026-04-19"
DESCRIPTION = "Add deleted_at timestamp to tools for soft-delete"
...
CREATE_DELETED_AT_INDEX_SQL = """
    CREATE INDEX IF NOT EXISTS ix_tools_deleted_at
    ON tools (deleted_at);
"""

DROP_DELETED_AT_INDEX_SQL = """
    DROP INDEX IF EXISTS ix_tools_deleted_at;
"""
